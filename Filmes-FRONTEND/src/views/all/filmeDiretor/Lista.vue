<template>
    <master-page icone="mdi-movie-settings" titulo="Filme Diretor" subTitulo="Lista de Integração entre Filme e Diretores para uso no sistema">
        ...
        <cadastro-filme-diretor v-model="dialogCadastro" :item="item" @fechou="dialogCadastro = false" @salvou="Atualizar()"/>

    </master-page>    
</template>

<script lang="ts">
import { FilmeDiretor } from "@/core/models/all";
import { PageBase } from "@/core/models/shared";
import { FilmeDiretorService } from "@/core/services/geral";
import { Component, Prop, Watch, Vue } from "vue-property-decorator";

@Component
export default class ListaFilmeDiretor extends PageBase {
    search: any = '';
    ...
    AbrirDialogCadastro(item?: FilmeDiretor){
        if(item){
            ...
            this.item = new FilmeDiretor();
            this.dialogCadastro = true;
        }
    }

    Excluir(item: FilmeDiretor){
        this.$swal({    
            title: 'Atenção!',
