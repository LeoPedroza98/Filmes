<template>
    <master-page icone="mdi-filmstrip" titulo="Filmes" subTitulo="Lista de Filmes para uso no sistema">
        ...
        <cadastro-filme v-model="dialogCadastro" :item="item" @fechou="dialogCadastro = false" @salvou="Atualizar()"/>

    </master-page>    
</template>

<script lang="ts">
import { Filme, Usuario } from "@/core/models/all";
import { PageBase } from "@/core/models/shared";
import { FilmeService } from "@/core/services/geral";
import { Component, Prop, Watch, Vue } from "vue-property-decorator";

@Component
export default class ListaFilme extends PageBase {
    search: any = '';
    ...
    AbrirDialogCadastro(item?: Filme){
        if(item){
